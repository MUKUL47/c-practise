...
typedef void (*register_event_cb_entity)(char *k);
...
// events
void create_event_cb(GameInstance *gi, ENTITY_EVENT_TYPES event_name);
void register_event_cb(GameInstance *gi, ENTITY_EVENT_TYPES event_name,
                       register_event_cb_entity cb);
void invoke_event_cb(GameInstance *gi, ENTITY_EVENT_TYPES event_name);
